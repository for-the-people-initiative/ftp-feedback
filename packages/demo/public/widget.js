var FTPFeedback=(function(b){"use strict";var R=Object.defineProperty;var X=(b,w,T)=>w in b?R(b,w,{enumerable:!0,configurable:!0,writable:!0,value:T}):b[w]=T;var u=(b,w,T)=>X(b,typeof w!="symbol"?w+"":w,T);const w=`
:host {
...
`,T={minMoves:10,minScrolls:3,minKeyPresses:5,minTimeMs:6e4,minClicks:2,minClickDurationVariance:200,minPathVariance:.3,minScrollVariance:1e4,minTypingVariance:500,minSignalsToPass:3},k={cursorBehavior:28,scrollBehavior:12,keyPresses:10,typingPattern:12,clickBehavior:5,time:10,environment:10,backspaces:13},F=7,V=200,M=100;class O{constructor(e,t){u(this,"thresholds");u(this,"signals");u(this,"startTime",0);u(this,"target");u(this,"abortController",null);u(this,"pathPoints",[]);u(this,"pathIndex",0);u(this,"keyTimestamps",[]);u(this,"keyTsIndex",0);u(this,"clickDownTime",0);u(this,"clickDurations",[]);u(this,"scrollTimestamps",[]);u(this,"scrollPositions",[]);u(this,"scrollTsIndex",0);this.thresholds={...T,...e},this.target=t||document,this.signals={mouseMoves:0,scrolls:0,keyPresses:0,clicks:0,timeOnPageMs:0,webdriver:!1,hasTouch:!1,screenConsistent:!0,pathAngleVariance:0,pathSamples:0,pathAvgSpeed:0,pathSpeedVariance:0,clickAvgDuration:0,clickDurationVariance:0,clickSamples:0,scrollIntervalVariance:0,scrollDirectionChanges:0,scrollSamples:0,typingVariance:0,backspaceCount:0,typingSamples:0,typingAvgInterval:0}}start(){this.startTime=Date.now(),this.abortController=new AbortController;const e={signal:this.abortController.signal,passive:!0};let t=0,s=0;this.target.addEventListener("mousemove",r=>{const n=Date.now();if(n-t>50){this.signals.mouseMoves++,t=n;const o=r;this.addPathPoint(o.clientX,o.clientY,n)}},e),this.target.addEventListener("touchmove",r=>{const n=Date.now();if(n-t>50){this.signals.mouseMoves++,t=n;const o=r;o.touches.length>0&&this.addPathPoint(o.touches[0].clientX,o.touches[0].clientY,n)}},e);const i=()=>{const r=Date.now();if(r-s>200){this.signals.scrolls++,s=r;const n=window.scrollY||document.documentElement.scrollTop||0;if(this.scrollTimestamps.length<M)this.scrollTimestamps.push(r),this.scrollPositions.push(n);else{const o=this.scrollTsIndex%M;this.scrollTimestamps[o]=r,this.scrollPositions[o]=n}this.scrollTsIndex++}};this.target.addEventListener("scroll",i,e),window.addEventListener("scroll",i,e),this.target.addEventListener("keydown",r=>{this.signals.keyPresses++;const n=Date.now(),o=r;(o.key==="Backspace"||o.key==="Delete")&&this.signals.backspaceCount++,this.keyTimestamps.length<M?this.keyTimestamps.push(n):this.keyTimestamps[this.keyTsIndex%M]=n,this.keyTsIndex++},e),this.target.addEventListener("mousedown",()=>{this.clickDownTime=Date.now()},e),this.target.addEventListener("mouseup",()=>{if(this.clickDownTime>0){const r=Date.now()-this.clickDownTime;this.signals.clicks++,r<2e3&&this.clickDurations.push(r),this.clickDownTime=0}},e),this.target.addEventListener("touchstart",()=>{this.clickDownTime=Date.now()},e),this.target.addEventListener("touchend",()=>{if(this.clickDownTime>0){const r=Date.now()-this.clickDownTime;this.signals.clicks++,r<2e3&&this.clickDurations.push(r),this.clickDownTime=0}},e),this.signals.webdriver=!!navigator.webdriver,this.signals.hasTouch="ontouchstart"in window||navigator.maxTouchPoints>0,this.signals.screenConsistent=this.checkScreenConsistency()}evaluate(){this.signals.timeOnPageMs=Date.now()-this.startTime,this.analyzePath(),this.analyzeClicks(),this.analyzeScrolling(),this.analyzeTyping();const e=this.thresholds,t=this.signals,s=t.mouseMoves>=e.minMoves&&t.pathAngleVariance>=e.minPathVariance&&t.pathSamples>=5,i=t.scrolls>=e.minScrolls&&(t.scrollIntervalVariance>=e.minScrollVariance||t.scrollDirectionChanges>=1),r=t.keyPresses>=e.minKeyPresses,n=t.clickAvgDuration>=30&&t.clickAvgDuration<=500,o=t.clicks>=e.minClicks&&(t.clickDurationVariance>=e.minClickDurationVariance||n&&t.clickSamples>=2),c=t.timeOnPageMs>=e.minTimeMs,a=t.typingVariance>=e.minTypingVariance&&t.typingSamples>=5||t.backspaceCount>=1,l=!t.webdriver&&t.screenConsistent,d={cursorBehavior:{proven:s,value:t.mouseMoves,threshold:e.minMoves,label:"Cursor behavior"},scrollBehavior:{proven:i,value:t.scrolls,threshold:e.minScrolls,label:"Scroll behavior"},keyPresses:{proven:r,value:t.keyPresses,threshold:e.minKeyPresses,label:"Key presses"},clickBehavior:{proven:o,value:t.clicks,threshold:e.minClicks,label:"Click behavior"},time:{proven:c,value:t.timeOnPageMs,threshold:e.minTimeMs,label:"Time on page"},typingPattern:{proven:a,value:t.typingVariance,threshold:e.minTypingVariance,label:"Typing rhythm"},environment:{proven:l,value:l?1:0,threshold:1,label:"Environment"}},g=Object.values(d).filter(I=>I.proven).length,f=Math.min(Math.round(g/e.minSignalsToPass*100),100),y=g>=e.minSignalsToPass,x=Math.min(t.mouseMoves/e.minMoves,1),P=this.cursorPathScore(),A=x*P,E=t.typingSamples>=3?Math.min(t.typingVariance/e.minTypingVariance,1):0,C=Math.min(t.backspaceCount/2,1),z=Math.round(A*k.cursorBehavior+Math.min(t.scrolls/e.minScrolls,1)*(t.scrollDirectionChanges>=1||t.scrollIntervalVariance>=e.minScrollVariance?1:.3)*k.scrollBehavior+Math.min(t.keyPresses/e.minKeyPresses,1)*k.keyPresses+E*k.typingPattern+Math.min(t.clicks/e.minClicks,1)*(n?1:.3)*k.clickBehavior+Math.min(t.timeOnPageMs/e.minTimeMs,1)*k.time+this.envScore()*k.environment+C*k.backspaces);return{score:f,passed:y,provenCount:g,totalSignals:F,minRequired:e.minSignalsToPass,confidenceScore:z,breakdown:d,signals:{...this.signals}}}evaluateWith(e){const t={...this.signals},s=this.startTime;Object.assign(this.signals,e),e.timeOnPageMs!==void 0&&(this.startTime=Date.now()-e.timeOnPageMs);const i=this.evaluate();return this.signals=t,this.startTime=s,i}getThresholds(){return{...this.thresholds}}setThresholds(e){Object.assign(this.thresholds,e)}destroy(){var e;(e=this.abortController)==null||e.abort(),this.abortController=null,this.pathPoints=[],this.keyTimestamps=[],this.scrollTimestamps=[],this.scrollPositions=[],this.clickDurations=[]}analyzeClicks(){const e=this.clickDurations;if(this.signals.clickSamples=e.length,e.length<2){this.signals.clickAvgDuration=e.length===1?e[0]:0,this.signals.clickDurationVariance=0;return}this.signals.clickAvgDuration=e.reduce((t,s)=>t+s,0)/e.length,this.signals.clickDurationVariance=this.variance(e)}analyzeScrolling(){const e=this.scrollTimestamps,t=this.scrollPositions;if(this.signals.scrollSamples=e.length,e.length<3){this.signals.scrollIntervalVariance=0,this.signals.scrollDirectionChanges=0;return}const s=e.map((a,l)=>l).sort((a,l)=>e[a]-e[l]),i=s.map(a=>e[a]),r=s.map(a=>t[a]),n=[];for(let a=1;a<i.length;a++){const l=i[a]-i[a-1];l<5e3&&n.push(l)}this.signals.scrollIntervalVariance=n.length>=2?this.variance(n):0;let o=0,c=0;for(let a=1;a<r.length;a++){const l=r[a]-r[a-1];if(l===0)continue;const d=l>0?1:-1;c!==0&&d!==c&&o++,c=d}this.signals.scrollDirectionChanges=o}analyzeTyping(){const e=this.keyTimestamps;if(this.signals.typingSamples=e.length,e.length<3){this.signals.typingVariance=0,this.signals.typingAvgInterval=0;return}const t=[...e].sort((i,r)=>i-r),s=[];for(let i=1;i<t.length;i++){const r=t[i]-t[i-1];r<5e3&&s.push(r)}if(s.length<2){this.signals.typingVariance=0,this.signals.typingAvgInterval=0;return}this.signals.typingAvgInterval=s.reduce((i,r)=>i+r,0)/s.length,this.signals.typingVariance=this.variance(s)}addPathPoint(e,t,s){this.pathPoints.length<V?this.pathPoints.push({x:e,y:t,t:s}):this.pathPoints[this.pathIndex%V]={x:e,y:t,t:s},this.pathIndex++}analyzePath(){const e=this.pathPoints;if(this.signals.pathSamples=e.length,e.length<3){this.signals.pathAngleVariance=0,this.signals.pathAvgSpeed=0,this.signals.pathSpeedVariance=0;return}const t=[],s=[];for(let i=1;i<e.length;i++){const r=e[i].x-e[i-1].x,n=e[i].y-e[i-1].y,o=e[i].t-e[i-1].t,c=Math.sqrt(r*r+n*n);if(o>0&&s.push(c/o),i>=2){const a=e[i-1].x-e[i-2].x,l=e[i-1].y-e[i-2].y,d=Math.atan2(l,a);let f=Math.atan2(n,r)-d;for(;f>Math.PI;)f-=2*Math.PI;for(;f<-Math.PI;)f+=2*Math.PI;t.push(f)}}this.signals.pathAngleVariance=this.variance(t),s.length>0&&(this.signals.pathAvgSpeed=s.reduce((i,r)=>i+r,0)/s.length,this.signals.pathSpeedVariance=this.variance(s))}cursorPathScore(){if(this.pathPoints.length<5)return .5;let t=0;const s=this.signals.pathAngleVariance;t+=Math.min(s/this.thresholds.minPathVariance,1)*.6;const i=this.signals.pathSpeedVariance,r=i>.01?Math.min(i/.1,1):0;return t+=r*.4,Math.min(t,1)}envScore(){let e=1;return this.signals.webdriver&&(e-=.6),this.signals.screenConsistent||(e-=.3),this.signals.hasTouch&&this.signals.mouseMoves===0&&this.signals.timeOnPageMs>1e4&&(e-=.1),Math.max(0,e)}checkScreenConsistency(){const{innerWidth:e,innerHeight:t,screen:s}=window;return!(e===0||t===0||s.width===0||s.height===0||e>s.width+50||t>s.height+50)}variance(e){if(e.length<2)return 0;const t=e.reduce((i,r)=>i+r,0)/e.length;return e.map(i=>(i-t)**2).reduce((i,r)=>i+r,0)/e.length}}const D={bug:{totalSteps:5,steps:[{key:"title",title:"What happened?",subtitle:"Give a brief title for the bug",type:"input",required:!0,placeholder:"e.g. Button doesn't respond when clicked"},{key:"reproduction",title:"Steps to reproduce",subtitle:"What were you doing when this happened?",type:"textarea",required:!1,placeholder:"I clicked on... then I..."},{key:"expected",title:"Expected vs actual",subtitle:"What should have happened instead?",type:"textarea",required:!1,placeholder:"I expected... but instead..."},{key:"severity",title:"How severe is this?",subtitle:"Pick the option that best describes the impact",type:"severity",required:!0},{key:"screenshots",title:"Add screenshots",subtitle:"Attach images to help us understand (optional)",type:"upload",required:!1}]},suggestion:{totalSteps:4,steps:[{key:"title",title:"What's your idea?",subtitle:"A short title for your suggestion",type:"input",required:!0,placeholder:"e.g. Add dark mode support"},{key:"description",title:"Tell us more",subtitle:"Describe your idea in detail",type:"textarea",required:!1,placeholder:"It would be great if..."},{key:"motivation",title:"Why does it matter?",subtitle:"Help us understand the value (optional)",type:"textarea",required:!1,placeholder:"This would help because..."},{key:"screenshots",title:"Add screenshots",subtitle:"Attach images to help us understand (optional)",type:"upload",required:!1}]},question:{totalSteps:3,steps:[{key:"title",title:"What's your question?",subtitle:"Ask away — no question is too small",type:"textarea",required:!0,placeholder:"How do I..."},{key:"context",title:"Where are you stuck?",subtitle:"Share the page or context (optional)",type:"input",required:!1,placeholder:"URL or description",defaultValue:()=>window.location.href},{key:"screenshots",title:"Add screenshots",subtitle:"Attach images to help us understand (optional)",type:"upload",required:!1}]}},_=[{value:"blocking",label:"Blocking",icon:"🔴",desc:"Can't continue"},{value:"major",label:"Major",icon:"🟠",desc:"Significant issue"},{value:"minor",label:"Minor",icon:"🟡",desc:"Small annoyance"},{value:"cosmetic",label:"Cosmetic",icon:"🟢",desc:"Visual only"}],$="ftp-feedback-draft",H="https://ftp-feedback-api.onrender.com";class j extends HTMLElement{constructor(){super();u(this,"shadow");u(this,"config");u(this,"isOpen",!1);u(this,"wizard",{category:null,step:0,data:{}});u(this,"submitting",!1);u(this,"trust",null);u(this,"dragCleanup",null);this.shadow=this.attachShadow({mode:"open"}),this.config={appId:"",apiUrl:H,position:"bottom-right",formPosition:"",theme:"light",themeColors:null,categories:["bug","suggestion","question"],user:{}}}static get observedAttributes(){return["app-id","api-url","position","theme","categories","user-id","user-email","branding","no-trigger","draggable","trust-min-moves","trust-min-scrolls","trust-min-keys","trust-min-time","trust-min-clicks"]}connectedCallback(){this.config.appId=this.getAttribute("app-id")||this.config.appId,this.config.apiUrl=this.getAttribute("api-url")||this.config.apiUrl,this.config.position=this.getAttribute("position")||this.config.position,this.config.theme=this.getAttribute("theme")||this.config.theme,this.config.user.id=this.getAttribute("user-id")||void 0,this.config.user.email=this.getAttribute("user-email")||void 0,this.config.formPosition=this.getAttribute("data-form-position")||"";const t=this.getAttribute("categories");t&&(this.config.categories=t.split(",").map(l=>l.trim())),this.config.theme!=="light"&&this.setAttribute("theme",this.config.theme);const s=this.getAttribute("data-theme-colors");if(s)try{this.config.themeColors=JSON.parse(s)}catch{}if(this.config.themeColors){const l=this.shadow.host;this.config.themeColors.primary&&l.style.setProperty("--ftp-theme-primary",this.config.themeColors.primary),this.config.themeColors.gradient&&l.style.setProperty("--ftp-theme-gradient",this.config.themeColors.gradient)}const i={},r=this.getAttribute("trust-min-moves"),n=this.getAttribute("trust-min-scrolls"),o=this.getAttribute("trust-min-keys"),c=this.getAttribute("trust-min-time"),a=this.getAttribute("trust-min-clicks");r&&(i.minMoves=parseInt(r)),n&&(i.minScrolls=parseInt(n)),o&&(i.minKeyPresses=parseInt(o)),c&&(i.minTimeMs=parseInt(c)),a&&(i.minClicks=parseInt(a)),this.trust=new O(i),this.trust.start(),this.hasAttribute("draggable")&&this.getAttribute("draggable")!=="false"&&this.initDraggable(),this.loadDraft(),this.render()}disconnectedCallback(){var t,s;(t=this.trust)==null||t.destroy(),(s=this.dragCleanup)==null||s.call(this),this.dragCleanup=null}initDraggable(){const t=this,s="ftp-feedback-position";t.style.position="fixed",t.style.zIndex="99999",t.style.cursor="grab",t.style.touchAction="none",t.style.userSelect="none";const i=sessionStorage.getItem(s);if(i)try{const{right:h,bottom:m}=JSON.parse(i);t.style.right=`${h}px`,t.style.bottom=`${m}px`}catch{}let r=!1,n=!1,o=0,c=0,a=0,l=0;function d(){const h=t.getBoundingClientRect();return{right:window.innerWidth-h.right,bottom:window.innerHeight-h.bottom}}function g(h,m){const v=t.getBoundingClientRect(),S=window.innerWidth-v.width,B=window.innerHeight-v.height;return{right:Math.max(0,Math.min(h,S)),bottom:Math.max(0,Math.min(m,B))}}function f(h,m){r=!0,n=!1,o=h,c=m;const v=d();a=v.right,l=v.bottom,t.style.cursor="grabbing",t.style.transition="none"}function y(h,m){if(!r)return;const v=h-o,S=m-c;if(!n&&Math.abs(v)<4&&Math.abs(S)<4)return;n=!0;const{right:B,bottom:W}=g(a-v,l-S);t.style.right=`${B}px`,t.style.bottom=`${W}px`}function x(){r&&(r=!1,t.style.cursor="grab",t.style.transition="",n&&sessionStorage.setItem(s,JSON.stringify(d())))}const P=h=>{var m,v;(v=(m=h.target).closest)!=null&&v.call(m,'form, textarea, input, select, button:not([class*="trigger"])')||(h.preventDefault(),f(h.clientX,h.clientY))},A=h=>{r&&h.preventDefault(),y(h.clientX,h.clientY)},E=()=>x(),C=h=>{var v,S;if((S=(v=h.target).closest)!=null&&S.call(v,'form, textarea, input, select, button:not([class*="trigger"])'))return;const m=h.touches[0];f(m.clientX,m.clientY)},z=h=>{if(!r)return;h.preventDefault();const m=h.touches[0];y(m.clientX,m.clientY)},I=()=>x(),q=h=>{n&&(h.stopPropagation(),h.preventDefault(),n=!1)};t.addEventListener("mousedown",P),window.addEventListener("mousemove",A),window.addEventListener("mouseup",E),t.addEventListener("touchstart",C,{passive:!0}),window.addEventListener("touchmove",z,{passive:!1}),window.addEventListener("touchend",I),t.addEventListener("click",q,!0),this.dragCleanup=()=>{t.removeEventListener("mousedown",P),window.removeEventListener("mousemove",A),window.removeEventListener("mouseup",E),t.removeEventListener("touchstart",C),window.removeEventListener("touchmove",z),window.removeEventListener("touchend",I),t.removeEventListener("click",q,!0)}}configure(t){Object.assign(this.config,t),t.theme&&this.setAttribute("theme",t.theme),this.render()}open(){this.isOpen=!0,this.render()}close(){this.isOpen=!1,this.submitting=!1,this.render()}resetWizard(){this.wizard={category:null,step:0,data:{}},this.clearDraft()}saveDraft(){try{sessionStorage.setItem($,JSON.stringify(this.wizard))}catch{}}loadDraft(){try{const t=sessionStorage.getItem($);if(t){const s=JSON.parse(t);s.category&&(this.wizard=s)}}catch{}}clearDraft(){try{sessionStorage.removeItem($)}catch{}}get flow(){return this.wizard.category?D[this.wizard.category]:null}get totalStepsWithConfirm(){return this.flow?this.flow.totalSteps+1:0}get currentFlowStep(){var t;return(t=this.flow)==null?void 0:t.steps[this.wizard.step-1]}get isConfirmStep(){return this.flow&&this.wizard.step===this.flow.totalSteps+1}canProceed(){var i;const t=this.currentFlowStep;return!t||!t.required?!0:!!((i=this.wizard.data[t.key])==null?void 0:i.trim())}render(){const t=this.config.position;this.shadow.innerHTML=`
    ...
    `}renderFlowStep(){var n;const t=this.currentFlowStep,s=this.wizard.data[t.key]??(((n=t.defaultValue)==null?void 0:n.call(t))||"");t.required;const i=this.wizard.step===this.flow.totalSteps;let r="";if(t.type==="input")r=`<input type="text" id="stepInput" placeholder="${t.placeholder||""}" value="${this.escAttr(s)}" maxlength="200">`;else if(t.type==="textarea")r=`<textarea id="stepInput" placeholder="${t.placeholder||""}" rows="4">${this.escHtml(s)}</textarea>`;else if(t.type==="upload"){const o=this.wizard.data.screenshots||[],c=o.map((a,l)=>`
      ...
      `}else t.type==="severity"&&(r=`<div class="severity-grid">${_.map(o=>`
