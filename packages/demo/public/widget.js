var FTPFeedback=(function(h){"use strict";var O=Object.defineProperty;var V=(h,f,x)=>f in h?O(h,f,{enumerable:!0,configurable:!0,writable:!0,value:x}):h[f]=x;var d=(h,f,x)=>V(h,typeof f!="symbol"?f+"":f,x);const f=`
:host {
  --ftp-primary: #f97316;
...
`,x={minMoves:10,minScrolls:3,minKeyPresses:5,minTimeMs:6e4,minClicks:2,minPathVariance:.3,minTypingVariance:500,minSignalsToPass:3},m={moves:12,scrolls:8,keyPresses:10,typingPattern:10,clicks:5,time:12,cursorPath:23,environment:10,backspaces:10},E=8,P=200,T=100;class M{constructor(e,t){d(this,"thresholds");d(this,"signals");d(this,"startTime",0);d(this,"target");d(this,"abortController",null);d(this,"pathPoints",[]);d(this,"pathIndex",0);d(this,"keyTimestamps",[]);d(this,"keyTsIndex",0);this.thresholds={...x,...e},this.target=t||document,this.signals={mouseMoves:0,scrolls:0,keyPresses:0,clicks:0,timeOnPageMs:0,webdriver:!1,hasTouch:!1,screenConsistent:!0,pathAngleVariance:0,pathSamples:0,pathAvgSpeed:0,pathSpeedVariance:0,typingVariance:0,backspaceCount:0,typingSamples:0,typingAvgInterval:0}}start(){this.startTime=Date.now(),this.abortController=new AbortController;const e={signal:this.abortController.signal,passive:!0};let t=0,i=0;this.target.addEventListener("mousemove",s=>{const r=Date.now();if(r-t>50){this.signals.mouseMoves++,t=r;const n=s;this.addPathPoint(n.clientX,n.clientY,r)}},e),this.target.addEventListener("touchmove",s=>{const r=Date.now();if(r-t>50){this.signals.mouseMoves++,t=r;const n=s;n.touches.length>0&&this.addPathPoint(n.touches[0].clientX,n.touches[0].clientY,r)}},e),this.target.addEventListener("scroll",()=>{const s=Date.now();s-i>200&&(this.signals.scrolls++,i=s)},e),window.addEventListener("scroll",()=>{const s=Date.now();s-i>200&&(this.signals.scrolls++,i=s)},e),this.target.addEventListener("keydown",s=>{this.signals.keyPresses++;const r=Date.now(),n=s;(n.key==="Backspace"||n.key==="Delete")&&this.signals.backspaceCount++,this.keyTimestamps.length<T?this.keyTimestamps.push(r):this.keyTimestamps[this.keyTsIndex%T]=r,this.keyTsIndex++},e),this.target.addEventListener("click",()=>{this.signals.clicks++},e),this.target.addEventListener("touchstart",()=>{this.signals.clicks++},e),this.signals.webdriver=!!navigator.webdriver,this.signals.hasTouch="ontouchstart"in window||navigator.maxTouchPoints>0,this.signals.screenConsistent=this.checkScreenConsistency()}evaluate(){this.signals.timeOnPageMs=Date.now()-this.startTime,this.analyzePath(),this.analyzeTyping();const e=this.thresholds,t=this.signals,i=t.mouseMoves>=e.minMoves,s=t.scrolls>=e.minScrolls,r=t.keyPresses>=e.minKeyPresses,n=t.clicks>=e.minClicks,a=t.timeOnPageMs>=e.minTimeMs,l=t.pathAngleVariance>=e.minPathVariance&&t.pathSamples>=5,c=t.typingVariance>=e.minTypingVariance&&t.typingSamples>=5||t.backspaceCount>=1,g=!t.webdriver&&t.screenConsistent,p={moves:{proven:i,value:t.mouseMoves,threshold:e.minMoves,label:"Mouse moves"},scrolls:{proven:s,value:t.scrolls,threshold:e.minScrolls,label:"Scrolls"},keyPresses:{proven:r,value:t.keyPresses,threshold:e.minKeyPresses,label:"Key presses"},clicks:{proven:n,value:t.clicks,threshold:e.minClicks,label:"Clicks"},time:{proven:a,value:t.timeOnPageMs,threshold:e.minTimeMs,label:"Time on page"},cursorPath:{proven:l,value:t.pathAngleVariance,threshold:e.minPathVariance,label:"Cursor path"},typingPattern:{proven:c,value:t.typingVariance,threshold:e.minTypingVariance,label:"Typing rhythm"},environment:{proven:g,value:g?1:0,threshold:1,label:"Environment"}},v=Object.values(p).filter(L=>L.proven).length,u=Math.min(Math.round(v/e.minSignalsToPass*100),100),b=v>=e.minSignalsToPass,y=t.typingSamples>=3?Math.min(t.typingVariance/e.minTypingVariance,1):0,$=Math.min(t.backspaceCount/2,1),C=Math.round(Math.min(t.mouseMoves/e.minMoves,1)*m.moves+Math.min(t.scrolls/e.minScrolls,1)*m.scrolls+Math.min(t.keyPresses/e.minKeyPresses,1)*m.keyPresses+y*m.typingPattern+Math.min(t.clicks/e.minClicks,1)*m.clicks+Math.min(t.timeOnPageMs/e.minTimeMs,1)*m.time+this.cursorPathScore()*m.cursorPath+this.envScore()*m.environment+$*m.backspaces);return{score:u,passed:b,provenCount:v,totalSignals:E,minRequired:e.minSignalsToPass,confidenceScore:C,breakdown:p,signals:{...this.signals}}}evaluateWith(e){const t={...this.signals},i=this.startTime;Object.assign(this.signals,e),e.timeOnPageMs!==void 0&&(this.startTime=Date.now()-e.timeOnPageMs);const s=this.evaluate();return this.signals=t,this.startTime=i,s}getThresholds(){return{...this.thresholds}}setThresholds(e){Object.assign(this.thresholds,e)}destroy(){var e;(e=this.abortController)==null||e.abort(),this.abortController=null,this.pathPoints=[],this.keyTimestamps=[]}analyzeTyping(){const e=this.keyTimestamps;if(this.signals.typingSamples=e.length,e.length<3){this.signals.typingVariance=0,this.signals.typingAvgInterval=0;return}const t=[...e].sort((s,r)=>s-r),i=[];for(let s=1;s<t.length;s++){const r=t[s]-t[s-1];r<5e3&&i.push(r)}if(i.length<2){this.signals.typingVariance=0,this.signals.typingAvgInterval=0;return}this.signals.typingAvgInterval=i.reduce((s,r)=>s+r,0)/i.length,this.signals.typingVariance=this.variance(i)}addPathPoint(e,t,i){this.pathPoints.length<P?this.pathPoints.push({x:e,y:t,t:i}):this.pathPoints[this.pathIndex%P]={x:e,y:t,t:i},this.pathIndex++}analyzePath(){const e=this.pathPoints;if(this.signals.pathSamples=e.length,e.length<3){this.signals.pathAngleVariance=0,this.signals.pathAvgSpeed=0,this.signals.pathSpeedVariance=0;return}const t=[],i=[];for(let s=1;s<e.length;s++){const r=e[s].x-e[s-1].x,n=e[s].y-e[s-1].y,a=e[s].t-e[s-1].t,l=Math.sqrt(r*r+n*n);if(a>0&&i.push(l/a),s>=2){const c=e[s-1].x-e[s-2].x,g=e[s-1].y-e[s-2].y,p=Math.atan2(g,c);let u=Math.atan2(n,r)-p;for(;u>Math.PI;)u-=2*Math.PI;for(;u<-Math.PI;)u+=2*Math.PI;t.push(u)}}this.signals.pathAngleVariance=this.variance(t),i.length>0&&(this.signals.pathAvgSpeed=i.reduce((s,r)=>s+r,0)/i.length,this.signals.pathSpeedVariance=this.variance(i))}cursorPathScore(){if(this.pathPoints.length<5)return .5;let t=0;const i=this.signals.pathAngleVariance;t+=Math.min(i/this.thresholds.minPathVariance,1)*.6;const s=this.signals.pathSpeedVariance,r=s>.01?Math.min(s/.1,1):0;return t+=r*.4,Math.min(t,1)}envScore(){let e=1;return this.signals.webdriver&&(e-=.6),this.signals.screenConsistent||(e-=.3),this.signals.hasTouch&&this.signals.mouseMoves===0&&this.signals.timeOnPageMs>1e4&&(e-=.1),Math.max(0,e)}checkScreenConsistency(){const{innerWidth:e,innerHeight:t,screen:i}=window;return!(e===0||t===0||i.width===0||i.height===0||e>i.width+50||t>i.height+50)}variance(e){if(e.length<2)return 0;const t=e.reduce((s,r)=>s+r,0)/e.length;return e.map(s=>(s-t)**2).reduce((s,r)=>s+r,0)/e.length}}const w={bug:{totalSteps:4,steps:[{key:"title",title:"What happened?",subtitle:"Give a brief title for the bug",type:"input",required:!0,placeholder:"e.g. Button doesn't respond when clicked"},{key:"reproduction",title:"Steps to reproduce",subtitle:"What were you doing when this happened?",type:"textarea",required:!1,placeholder:"I clicked on... then I..."},{key:"expected",title:"Expected vs actual",subtitle:"What should have happened instead?",type:"textarea",required:!1,placeholder:"I expected... but instead..."},{key:"severity",title:"How severe is this?",subtitle:"Pick the option that best describes the impact",type:"severity",required:!0}]},suggestion:{totalSteps:3,steps:[{key:"title",title:"What's your idea?",subtitle:"A short title for your suggestion",type:"input",required:!0,placeholder:"e.g. Add dark mode support"},{key:"description",title:"Tell us more",subtitle:"Describe your idea in detail",type:"textarea",required:!1,placeholder:"It would be great if..."},{key:"motivation",title:"Why does it matter?",subtitle:"Help us understand the value (optional)",type:"textarea",required:!1,placeholder:"This would help because..."}]},question:{totalSteps:2,steps:[{key:"title",title:"What's your question?",subtitle:"Ask away — no question is too small",type:"textarea",required:!0,placeholder:"How do I..."},{key:"context",title:"Where are you stuck?",subtitle:"Share the page or context (optional)",type:"input",required:!1,placeholder:"URL or description",defaultValue:()=>window.location.href}]}},A=[{value:"blocking",label:"Blocking",icon:"🔴",desc:"Can't continue"},{value:"major",label:"Major",icon:"🟠",desc:"Significant issue"},{value:"minor",label:"Minor",icon:"🟡",desc:"Small annoyance"},{value:"cosmetic",label:"Cosmetic",icon:"🟢",desc:"Visual only"}],k="ftp-feedback-draft",I="https://ftp-feedback-api.onrender.com";class z extends HTMLElement{constructor(){super();d(this,"shadow");d(this,"config");d(this,"isOpen",!1);d(this,"wizard",{category:null,step:0,data:{}});d(this,"submitting",!1);d(this,"trust",null);this.shadow=this.attachShadow({mode:"open"}),this.config={appId:"",apiUrl:I,position:"bottom-right",theme:"light",categories:["bug","suggestion","question"],user:{}}}static get observedAttributes(){return["app-id","api-url","position","theme","categories","user-id","user-email","branding","trust-min-moves","trust-min-scrolls","trust-min-keys","trust-min-time","trust-min-clicks"]}connectedCallback(){this.config.appId=this.getAttribute("app-id")||this.config.appId,this.config.apiUrl=this.getAttribute("api-url")||this.config.apiUrl,this.config.position=this.getAttribute("position")||this.config.position,this.config.theme=this.getAttribute("theme")||this.config.theme,this.config.user.id=this.getAttribute("user-id")||void 0,this.config.user.email=this.getAttribute("user-email")||void 0;const t=this.getAttribute("categories");t&&(this.config.categories=t.split(",").map(c=>c.trim())),this.config.theme!=="light"&&this.setAttribute("theme",this.config.theme);const i={},s=this.getAttribute("trust-min-moves"),r=this.getAttribute("trust-min-scrolls"),n=this.getAttribute("trust-min-keys"),a=this.getAttribute("trust-min-time"),l=this.getAttribute("trust-min-clicks");s&&(i.minMoves=parseInt(s)),r&&(i.minScrolls=parseInt(r)),n&&(i.minKeyPresses=parseInt(n)),a&&(i.minTimeMs=parseInt(a)),l&&(i.minClicks=parseInt(l)),this.trust=new M(i),this.trust.start(),this.loadDraft(),this.render()}disconnectedCallback(){var t;(t=this.trust)==null||t.destroy()}configure(t){Object.assign(this.config,t),t.theme&&this.setAttribute("theme",t.theme),this.render()}open(){this.isOpen=!0,this.render()}close(){this.isOpen=!1,this.submitting=!1,this.render()}resetWizard(){this.wizard={category:null,step:0,data:{}},this.clearDraft()}saveDraft(){try{sessionStorage.setItem(k,JSON.stringify(this.wizard))}catch{}}loadDraft(){try{const t=sessionStorage.getItem(k);if(t){const i=JSON.parse(t);i.category&&(this.wizard=i)}}catch{}}clearDraft(){try{sessionStorage.removeItem(k)}catch{}}get flow(){return this.wizard.category?w[this.wizard.category]:null}get totalStepsWithConfirm(){return this.flow?this.flow.totalSteps+1:0}get currentFlowStep(){var t;return(t=this.flow)==null?void 0:t.steps[this.wizard.step-1]}get isConfirmStep(){return this.flow&&this.wizard.step===this.flow.totalSteps+1}canProceed(){var s;const t=this.currentFlowStep;return!t||!t.required?!0:!!((s=this.wizard.data[t.key])==null?void 0:s.trim())}render(){const t=this.config.position;this.shadow.innerHTML=`
    ...
    `}categoryLabel(t){return t==="bug"?"🐛 Bug Report":t==="suggestion"?"💡 Suggestion":"❓ Question"}bindEvents(){var i,s,r,n,a;(i=this.shadow.getElementById("trigger"))==null||i.addEventListener("click",()=>this.isOpen?this.close():this.open()),(s=this.shadow.getElementById("close"))==null||s.addEventListener("click",()=>this.close()),this.shadow.querySelectorAll(".category-card").forEach(l=>{l.addEventListener("click",()=>{const c=l.dataset.cat;this.wizard.category=c,this.wizard.step=1,w[c].steps.forEach(p=>{p.defaultValue&&!this.wizard.data[p.key]&&(this.wizard.data[p.key]=p.defaultValue())}),this.saveDraft(),this.render()})});const t=this.shadow.getElementById("stepInput");t&&(t.addEventListener("input",()=>{const l=this.currentFlowStep;l&&(this.wizard.data[l.key]=t.value,this.saveDraft())}),requestAnimationFrame(()=>t.focus())),this.shadow.querySelectorAll(".severity-btn").forEach(l=>{l.addEventListener("click",()=>{const c=l.dataset.sev;this.wizard.data.severity=c,this.saveDraft(),this.shadow.querySelectorAll(".severity-btn").forEach(p=>p.classList.remove("active")),l.classList.add("active");const g=this.shadow.getElementById("nextBtn");g&&(g.disabled=!1)})}),(r=this.shadow.getElementById("backBtn"))==null||r.addEventListener("click",()=>{this.wizard.step<=1?(this.wizard.step=0,this.wizard.category=null):this.wizard.step--,this.saveDraft(),this.render()}),(n=this.shadow.getElementById("nextBtn"))==null||n.addEventListener("click",()=>{this.wizard.step++,this.saveDraft(),this.render()}),(a=this.shadow.getElementById("submitBtn"))==null||a.addEventListener("click",()=>this.submit())}async submit(){var c,g,p,v,u;if(this.submitting)return;this.submitting=!0,this.render();const t=this.wizard.category,i=this.wizard.data;let s={},r={};t==="bug"?(s={reproduction:i.reproduction||"",expected:i.expected||""},r={severity:i.severity||""}):t==="suggestion"?s={description:i.description||"",motivation:i.motivation||""}:s={context:i.context||""};const n=this.collectMetadata(),a=(c=this.trust)==null?void 0:c.evaluate(),l={type:t,title:i.title||"",body:JSON.stringify(s),user_id:this.config.user.id,user_email:this.config.user.email,page_url:window.location.href,route:window.location.pathname,user_agent:navigator.userAgent,viewport:`${window.innerWidth}x${window.innerHeight}`,metadata:{...n,...r,trust_score:a==null?void 0:a.score,trust_passed:a==null?void 0:a.passed,trust_signals:a==null?void 0:a.signals}};try{const b=await fetch(`${this.config.apiUrl}/v1/feedback`,{method:"POST",headers:{"Content-Type":"application/json","X-App-Id":this.config.appId},body:JSON.stringify(l)});if(!b.ok){const y=await b.json().catch(()=>({}));throw new Error(y.error||`HTTP ${b.status}`)}(p=(g=this.config).onSubmit)==null||p.call(g,l),this.clearDraft(),this.showSuccess()}catch(b){this.submitting=!1,this.render();const y=this.shadow.getElementById("errorMsg");y&&(y.textContent=b.message||"Failed to submit",y.style.display="block"),(u=(v=this.config).onError)==null||u.call(v,b)}}collectMetadata(){var l,c;const t=navigator.userAgent,i=navigator;let s="Unknown";/Windows NT 10/.test(t)?s="Windows 10/11":/Windows NT/.test(t)?s="Windows":/Mac OS X (\d+[._]\d+)/.test(t)?s=`macOS ${RegExp.$1.replace("_",".")}`:/iPhone OS (\d+[._]\d+)/.test(t)?s=`iOS ${RegExp.$1.replace("_",".")}`:/Android (\d+(\.\d+)?)/.test(t)?s=`Android ${RegExp.$1}`:/Linux/.test(t)&&(s="Linux");let r="Unknown";/Edg\/(\d+)/.test(t)?r=`Edge ${RegExp.$1}`:/Chrome\/(\d+)/.test(t)?r=`Chrome ${RegExp.$1}`:/Safari\/(\d+)/.test(t)&&/Version\/(\d+(\.\d+)?)/.test(t)?r=`Safari ${RegExp.$1}`:/Firefox\/(\d+)/.test(t)&&(r=`Firefox ${RegExp.$1}`);const n=/Mobi|Android.*Mobile|iPhone/.test(t),a=i.connection||i.mozConnection||i.webkitConnection;return{device_type:n?"mobile":"desktop",os:s,browser:r,screen_resolution:`${screen.width}x${screen.height}`,language:navigator.language,timezone:Intl.DateTimeFormat().resolvedOptions().timeZone,connection_type:(a==null?void 0:a.effectiveType)||null,color_scheme:(c=(l=window.matchMedia)==null?void 0:l.call(window,"(prefers-color-scheme: dark)"))!=null&&c.matches?"dark":"light",pixel_ratio:window.devicePixelRatio,online:navigator.onLine,referrer:document.referrer||null}}showSuccess(){this.wizard={category:null,step:0,data:{}};const t=this.shadow.getElementById("formBody");t&&(t.innerHTML=`
        <div class="success">
          <div class="check">✅</div>
          <h3>Thank you!</h3>
          <p>Your feedback has been submitted.</p>
        </div>
      `),setTimeout(()=>this.close(),2500)}escHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}escAttr(t){return this.escHtml(t).replace(/"/g,"&quot;")}}customElements.get("ftp-feedback")||customElements.define("ftp-feedback",z);const S={_el:null,init(o){var t,i,s;(t=document.querySelector("ftp-feedback"))==null||t.remove();const e=document.createElement("ftp-feedback");return e.setAttribute("app-id",o.appId),o.apiUrl&&e.setAttribute("api-url",o.apiUrl),o.position&&e.setAttribute("position",o.position),o.theme&&e.setAttribute("theme",o.theme),o.categories&&e.setAttribute("categories",o.categories.join(",")),(i=o.user)!=null&&i.id&&e.setAttribute("user-id",o.user.id),(s=o.user)!=null&&s.email&&e.setAttribute("user-email",o.user.email),document.body.appendChild(e),requestAnimationFrame(()=>{e.configure({onSubmit:o.onSubmit,onError:o.onError})}),this._el=e,e},open(){var o;(o=this._el)==null||o.open()},close(){var o;(o=this._el)==null||o.close()}};return(function(){const e=document.currentScript||document.querySelector("script[data-app-id]");if(e&&e instanceof HTMLScriptElement){const t=e.getAttribute("data-app-id");if(t){const i=()=>{var s;S.init({appId:t,apiUrl:e.getAttribute("data-api-url")||void 0,position:e.getAttribute("data-position")||void 0,theme:e.getAttribute("data-theme")||void 0,categories:(s=e.getAttribute("data-categories"))==null?void 0:s.split(",").map(r=>r.trim()),user:{id:e.getAttribute("data-user-id")||void 0,email:e.getAttribute("data-user-email")||void 0}})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",i):i()}}})(),h.FTPFeedback=S,h.FTPFeedbackElement=z,h.TrustScore=M,h.default=S,Object.defineProperties(h,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}}),h})({});
